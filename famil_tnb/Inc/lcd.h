...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
//#define LCD_REST_0 		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, RESET)//reset
//#define LCD_REST_1 		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, SET)//set
//LCD地址结构体
typedef struct
{
	uint16_t LCD_REG;
...
//////////////////////////////////////////////////////////////////////////////////
//定义LCD的命令和数据位.
//uint32_t UCGUI_LCD_CMD  = 0X6C00007E; //地址为0X6C00007E;  0111 1110  FSMC_A6为0 
//uint32_t UCGUI_LCD_DATA = 0X6C000080; //地址为0x6C000080;  1000 0000  FSMC_A6为1
//#define		FSMC_Addr_ILI9341_CMD			((uint32_t)0X6C00007E)
//#define 	FSMC_Addr_ILI9341_DATA		((uint32_t)0X6C000080)
#define		LCD_WRITE_REG							(*(__IO uint16_t*)FSMC_Addr_ILI9341_CMD)
#define		LCD_WRITE_DATA						(*(__IO uint16_t*)FSMC_Addr_ILI9341_DATA)
//扫描方向定义
...
void ILI93XX_LCD_Init(void);											//初始化
